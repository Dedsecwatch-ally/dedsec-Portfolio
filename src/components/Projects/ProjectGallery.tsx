...
const projects = [
    ...
    {
        title: "Underlay",
        description: "A powerful web browser focused on privacy and speed. Built for those who value their digital footprint.",
        repoUrl: "https://github.com/Dedsecwatch-ally/underlay",
        color: "#bd00ff"
    },
    {
        title: "Luxury",
        description: "A premium luxury brand website experience built with TypeScript. Elegant animations and sophisticated design patterns.",
        repoUrl: "https://github.com/Dedsecwatch-ally/Luxury",
        color: "#ff9100"
    },
    {
        title: "Glimpse",
        description: "A glimpse into modern web capabilities. Featuring advanced animations and interactive UI elements. Live demo available.",
        repoUrl: "https://github.com/Dedsecwatch-ally/Glimpse",
        color: "#00ff9d"
    },
    {
        title: "Apple Clone",
        description: "A pixel-perfect clone of the Apple website built with JavaScript. Recreating the iconic smooth scrolling and product presentations.",
        repoUrl: "https://github.com/Dedsecwatch-ally/my-apple-clone",
        color: "#00ccff"
    }
];
        ...
        <section className="overflow-hidden bg-void">
            <div ref={triggerRef} className="">
                <div ref={sectionRef} className="h-screen w-[600vw] flex flex-row relative">
                    ...
                    {/* Projects */}
                    <div className="w-[500vw] h-full flex items-center px-24 space-x-32 bg-zinc-950/50">
                        {projects.map((p, i) => (
                            <ProjectCard key={i} {...p} />
                        ))}
                    </div>
